...
export default function Home() {
  ...
  return (
    <main
      ...
      style={{
        // stadium.png goes in /public — falls back to dark green until image loads
    ...
    >
      {/* Overlay — preserves sky at top, darkens bottom for readability */}
      <div
      ...
      <div className="relative z-10 flex flex-col min-h-screen px-5 sm:px-10">
        ...
        {/* Spacer — pushes boxes toward the field */}
